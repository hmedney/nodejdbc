...
class PreparedStatement
    ...
    # Adds current parameters to this PreparedStatement's batch
    #
    addBatch: () ->
    ...
    # Executes all the statements that were added to the batch.
    #
    # @return [int array] a promise that returns an array where each element is # of rows updated for each statement
    executeBatch: ->
    ...
    #
    # @return [int] a promise that returns the result of the executed statement (number of rows updated)
    executeUpdate: ->
    ...
    #
    # @return [int] result of the executed statement (number of rows updated)
    executeUpdateSync: ->
        @preparedStatement.executeUpdateAsync()
